    ...
    <div class="ui stacked segment">
        ...
        <div class="ui top attached header">
            <div class="ui grid">
                <div class="two wide column">
                    <img src="{{url('images/logo-imss.png')}}" alt="" class="ui tiny image">
                </div>
                <div class="twelve wide column">
                    <h3 class="ui center aligned header" style="margin-top: 10px;">
                        Instituto Mexicano Del Seguro Social <br>
                        Departamento de Nutrición Y Dietetica HGR 36 <br>
                    </h3>
                </div>
                <div class="two wide column">
                    <img src="{{url('images/logo_nutricion.png')}}" alt="" style="margin-top:10px;">
                </div>
            </div>
        </div>
        <div class="ui attached segment">
            <div>
                ...
                <strong style="margin-left: 70%;">NSS: <p></p></strong>
            </div>
            <div id="dos">
                <strong>FECHA:</strong>
                <strong>EDAD:</strong>
            ...
            <table class="ui small celled definition table" style="margin-top: 15px;">
                <thead>
                <tr>
                    <th></th>
                    <th>RAC</th>
